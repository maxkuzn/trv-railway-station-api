...
// Source: github.com/maxkuzn/trv-railway-station-api/internal/app/repo (interfaces: EventRepo)
...
import (
	...
	model "github.com/maxkuzn/trv-railway-station-api/internal/model"
)
...
func (m *MockEventRepo) Add(arg0 []model.RailwayStationEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]model.RailwayStationEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]model.RailwayStationEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
