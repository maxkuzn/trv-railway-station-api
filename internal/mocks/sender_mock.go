...
// Source: github.com/maxkuzn/trv-railway-station-api/internal/app/sender (interfaces: EventSender)
...
func (m *MockEventSender) Send(arg0 *model.RailwayStationEvent) error {
	m.ctrl.T.Helper()
